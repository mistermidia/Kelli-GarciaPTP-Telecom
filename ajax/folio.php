    ...
    echo '<div class="col-lg-4 folio_effect mix graphic">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    ...
                    <p class="folio_cat"><a href="cliente.html">Graphic</a></p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 folio_effect mix app">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    ...
                    <p class="folio_cat"><a href="cliente.html">App</a></p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 folio_effect mix illustrtopm">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    ...
                    <p class="folio_cat"><a href="cliente.html">Illustration</a></p>
                </div>
            </div>
        </div>';
}elseif($count == 2){
    echo '<div class="col-lg-4 folio_effect mix dev">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    ...
                    <p class="folio_cat"><a href="cliente.html">Development</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 folio_effect mix illustrtopm">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    ...
                    <p class="folio_cat"><a href="cliente.html">UI/UX</a></p>
                </div>
            </div>
        </div>';
}
